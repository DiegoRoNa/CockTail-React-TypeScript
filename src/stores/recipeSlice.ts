...
// type para el store "createRecipeSlice"
...
// StateCreator, permite tipar el state, y le pasamos el type
// "& FavoritesSliceType, [], [], RecipesSliceType", es para anidar los slices, y poder usar sus states
